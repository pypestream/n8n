...
export class CreateUserManagement1636626154932 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`
			INSERT INTO "${tablePrefix}user" (id, firstName, lastName, createdAt, updatedAt, globalRoleId) values
			('${ownerUserId}', 'default', 'default', DateTime('now'), DateTime('now'), ${instanceOwnerRole[0].insertId})
		`);
